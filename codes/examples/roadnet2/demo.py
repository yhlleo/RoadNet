...
if __name__ == '__main__':
  ...
  for i in idxs:
    index=i
    print i
    im_file = "/home/tensorflow/yhl/tensorpack_data/RoadNet/Ottawa/{}/Ottawa-{}.tif".format(index, index)
    model_path = "/home/tensorflow/yhl/tensorpack/examples/train_log/unet-raw/model-40000.data-00000-of-00001"
