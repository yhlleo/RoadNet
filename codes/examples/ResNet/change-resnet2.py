...
class Model(ModelDesc):
    ...
    def _get_inputs(self):
        ...
        return [InputDesc(tf.float32, [None, INPUT_SHAPE, INPUT_SHAPE, 6], 'input'),
    ...
    return TrainConfig(
        ...
        callbacks=[
            ...
            ScheduledHyperParamSetter('learning_rate',
                                      [(30, 1e-2), (80, 1e-3), (125, 1e-4), (165, 1e-5)]),
...
def eval(model_file, data_dir, save_path):
    ...
    img_dir = os.path.join(data_dir, 'image_yuan')
    flo_dir = os.path.join(data_dir, 'move_data_test_cut2')
...
#        mask_path = os.path.join(mask_dir, 'p1_mk_'+fp_name+'.jpg')
        ...
        flo_path = fl
        mask_path = os.path.join(mask_dir, fp_name[:3]+ 'mk_'+ fp_name[3:] + '.jpg')
        ...
        flo /= (np.max(flo)+1e-10)
        mask /= (np.max(mask)+1e-10)
