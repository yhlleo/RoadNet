...
def im_eval(im_file, model_path, save_path):
  ...
  for ls in imgs:
    ...
    fname = ls.split('/')[-1]
    fname = fname.split('.')[0]
    mask = cv2.merge([outputs[0][0], outputs[0][0], outputs[0][0]])
...
if __name__ == '__main__':
  ...
  for i in idxs:
    index=i
    print i
    im_file = "/home/tensorflow/yhl/tensorpack_data/RoadNet/Ottawa/{}/extra-Ottawa-{}.tif".format(index, index)
    model_path = "/home/tensorflow/yhl/tensorpack/examples/train_log/roadnet0/model-80000.data-00000-of-00001"
    save_path = '/home/tensorflow/yhl/tensorpack_data/RoadNet/Ottawa/test/{}'.format(index)
